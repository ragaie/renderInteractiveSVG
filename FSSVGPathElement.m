...
- (instancetype)initWithAttributes:(NSDictionary *)attributes
{
   ...
   // NSLog(@"---%@",attributes.description);
    ...
    self.colorFill = [attributes objectForKey:@"fill"] ;
    if (_colorFill == NULL){
        self.colorFill = [[attributes objectForKey:@"style"] stringByReplacingOccurrencesOfString:@"fill:" withString:@""];
        
    }
    
  
   // NSLog(@"---%@",self.colorFill);

    
   // self.colorFill = @"#FF66A7";
    self.path = nil;
