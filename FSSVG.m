...
// add by ragaie
+ (instancetype)svgWithFilePath:(NSString *)filePath{
    
    
    return [[FSSVG alloc] initWithFilePath:filePath];
}
// add by ragaie
...
- (id)initWithFile:(NSString*)filename
{
    ...
    if(self) {
        ...
        NSLog(@"%@",[[NSBundle mainBundle] pathForResource:filename ofType:@"svg"]);
